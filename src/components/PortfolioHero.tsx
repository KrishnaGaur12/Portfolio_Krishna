    ...
    <section id="home" className="relative w-full h-[100svh] md:h-screen md:min-h-[650px] flex items-center justify-center p-2 md:p-4 overflow-hidden font-sans snap-start">
      ...
      <div className="relative w-full h-full md:min-h-0 bg-glass-gradient rounded-[1.5rem] md:rounded-[2.25rem] shadow-2xl overflow-hidden flex flex-col items-center justify-between border border-white/10 transition-all duration-300 py-10 md:py-0">
        ...
        <div className="relative flex-1 w-full flex flex-col items-center justify-center z-10 -mt-10">
          ...
          <div className="absolute top-[15%] left-[10%] md:left-[20%] animate-float-slow opacity-90 z-0 scale-75 md:scale-100" style={{ animationDelay: '0.5s', transform: 'rotate(-15deg)' }}>
          ...
          <div className="absolute bottom-[20%] right-[10%] md:bottom-[45%] md:right-[20%] animate-float-delayed opacity-80 z-0 scale-75 md:scale-100" style={{ animationDelay: '1.5s', transform: 'rotate(10deg)' }}>
          ...
          <FloatingCube label="Java" size={60} className="bottom-[15%] left-[35%] md:bottom-[15%] md:left-[10%] animate-float-slow scale-75 md:scale-100" animationDelay="0s" />
          <FloatingCube label="C++" size={50} className="bottom-[12%] right-[25%] md:bottom-[30%] md:right-[10%] animate-float-medium scale-75 md:scale-100" animationDelay="1s" />
          <FloatingCube label="AWS" size={40} className="top-[12%] left-[35%] md:top-[25%] md:left-[15%] animate-float-fast opacity-90 scale-75 md:scale-100" animationDelay="2s" />
          <FloatingCube label="Node" size={45} className="top-[18%] right-[15%] md:top-[30%] md:right-[15%] animate-float-slow opacity-90 scale-75 md:scale-100" animationDelay="1.5s" />
          <FloatingCube label="Python" size={55} className="top-[20%] left-[8%] md:top-[35%] md:left-[8%] animate-float-medium opacity-80 scale-75 md:scale-100" animationDelay="0.5s" />
          <FloatingCube label="AI/ML" size={48} className="bottom-[18%] right-[5%] md:bottom-[25%] md:right-[20%] animate-float-fast opacity-85 scale-75 md:scale-100" animationDelay="2.5s" />
          <FloatingCube label="Spring" size={42} className="top-[10%] right-[30%] md:top-[15%] md:right-[5%] animate-float-slow opacity-75 scale-75 md:scale-100" animationDelay="3s" />
